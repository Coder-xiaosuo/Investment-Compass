---
name: pa-final-flag-trend-end
description: Al Brooks 最终旗形（Final Flag）和趋势末端的完整知识。使用当 Codex 需要判断趋势是否进入末端阶段时。包含：最终旗形的结构识别、趋势末端的特征信号、Final Flag后的反转概率、趋势末端交易注意事项。
---
...
本技能包包含【最终旗形与趋势末端】的完整价格行为交易知识，源自 Al Brooks 价格行为体系。

源文件：`prompts/文件24-最终旗形与趋势末端.txt`
