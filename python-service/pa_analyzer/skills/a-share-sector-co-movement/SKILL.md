---
name: a-share-sector-co-movement
description: A股板块联动的特殊分析方法。使用当 Codex 分析A股市场且需要评估板块联动效应时。包含：板块龙头与跟风股识别、同板块联动节奏判断、概念板块轮动规律、行业主线确认方法。
---
...
本技能包包含【A股板块联动】的完整价格行为交易知识，源自 Al Brooks 价格行为体系。

源文件：`prompts/A股板块联动.txt`
