---
name: pa-rapid-bear-trading
description: Al Brooks 极速下跌/高潮形态的做多交易策略。使用当 Codex 已确认下跌高潮形态、需要生成可能反转交易方案时。包含：下跌高潮做多的条件过滤、SPS回撤入场、二次入场确认。严格遵守禁止追高潮/SCS硬禁令。
---
...
本技能包包含【极速下跌交易策略】的完整价格行为交易知识，源自 Al Brooks 价格行为体系。

源文件：`prompts/极速下跌交易策略.txt`
